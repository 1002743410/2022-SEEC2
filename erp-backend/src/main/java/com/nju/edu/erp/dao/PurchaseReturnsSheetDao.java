...
public interface PurchaseReturnsSheetDao {
    ...
    List<PurchaseReturnsSheetPO> getPRSByOperator(String o);
    List<PurchaseReturnsSheetPO> getPRSByTime(String b,String e);
    List<PurchaseSheetPO> getRPSBySupplier(Integer c);
    List<PurchaseReturnsSheetPO> getPRSByTimeEX(String b,String e);

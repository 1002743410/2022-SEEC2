...
public interface WarehouseOutputSheetDao {
    ...
    List<WarehouseIODetailPO> getWarehouseIODetailByTime(String beginTime, String endTime);
    Integer getWarehouseOutputProductQuantityByTime(String  beginTime,String endTime);
}

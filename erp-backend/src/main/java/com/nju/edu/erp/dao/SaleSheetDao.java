...
public interface SaleSheetDao {
    ...
    List<SaleSheetPO> getSSByTime(String b, String e);
    List<SaleSheetPO> getSSByOperator(String o);
    List<SaleSheetPO> getSSBySupplier(Integer c);

    List<SaleSheetPO> getSSByTimeEX(String b, String e);

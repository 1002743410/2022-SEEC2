...
public interface PurchaseSheetDao {
    ...
    List<PurchaseSheetPO> getPSByTime(String b,String e);
    List<PurchaseSheetPO> getPSByOperator(String o);
    List<PurchaseSheetPO> getPSBySupplier(Integer c);

    List<PurchaseSheetPO> getPSByTimeEX(String b,String e);
}

...
<!--          </el-menu-item>-->
        ...
        <el-submenu index="5"
         v-if="permit(PATH.CHECK_SD.requiresAuth)">
         <template slot="title">
           <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
              :index="PATH.CHECK_CC.path"
              v-if="permit(PATH.CHECK_CC.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">经营历程表</span>
          </el-menu-item>
          <el-menu-item
              :index="PATH.CHECK_CD.path"
              v-if="permit(PATH.CHECK_CD.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
        ...
        <el-submenu index="6"
          ...
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">优惠策略</span>
          </el-menu-item>
        </el-submenu>
        <el-submenu index="7"
                    v-if="permit(PATH.FINANCE_SHEET.requiresAuth)">
          <template slot="title">
            <i class="el-icon-receiving"></i>
            <span slot="title">财务管理</span>
          </template>
          <el-menu-item
              :index="PATH.FINANCE_SHEET.path"
              v-if="permit(PATH.FINANCE_SHEET.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">财务单据</span>
          </el-menu-item>
          <el-menu-item
              :index="PATH.BANK_MANAGE.path"
              v-if="permit(PATH.BANK_MANAGE.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
        ...
        <el-submenu index="8"
          ...
          <el-menu-item
              :index="PATH.STAFF_CHECK.path"
              v-if="permit(PATH.STAFF_CHECK.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
          ...
          <el-menu-item
              :index="PATH.POST_MANAGEMENT.path"
              v-if="permit(PATH.POST_MANAGEMENT.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">岗位信息</span>
          </el-menu-item>
          <el-menu-item
              :index="PATH.SALARY_STRATEGY.path"
              v-if="permit(PATH.SALARY_STRATEGY.requiresAuth)"
          >
            <i class="el-icon-receiving"></i>
            <span slot="title">酬薪规则制订</span>
          </el-menu-item>
        </el-submenu>
        <el-submenu index="9"
